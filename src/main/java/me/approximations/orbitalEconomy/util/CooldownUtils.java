...
public class CooldownUtils {
	...
	public static long getDelay(String id) {
		if (map.containsKey(id)) return map.get(id);
		return System.currentTimeMillis();
	}
	
	public static boolean acabouDelay(String id, long l) {
	...
	public static String getDelayString(String id, long l) {
	...
	public static void removeDelay(String id) {
		if (map.containsKey(id)) map.remove(id);
	}
	
	public static  boolean temDelay(String id) {
	...
	public static  String formatDifferenceStr(long time) {
		...
		if (minutes > 0) {
			sb.append(minutes).append(" ").append(minutes == 1 ? "minute" : "minutes").append(" ");
		}
		if (seconds > 0) {
	...
	public static String getDifferenceFormatStr(long timestamp) {
